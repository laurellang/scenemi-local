...
class TrainLoop:
    def __init__(self, args: TrainingOptions, model: nn.Module,
                 diffusion, data, val_data, niter, writer, eval_only=False):
        self.args = args
        ...
        print(self.keyframe_strategy, self.keyframe_interval, self.p1, self.p2)
