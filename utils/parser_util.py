...
class BaseOptions:
    ...
    img_folder: str = field(default=None,
                                 metadata={"help": "Img folder for load body parms"})
    test_noise_level: float = field(default=None,
                                 metadata={"help": "Noise level for get metrics"})
    test_file: str = field(default=None,
                                 metadata={"help": "Noise level for get metrics"})
    test_noise_force: bool = field(default=False, metadata={"help": "Force Noise Level."})
    noise: str = field(default="0.0, 0.2, 0.5, 1.0",
                                 metadata={"help": "noisy level for training data"})
...
@dataclass
class DataOptions:
    dataset: str = field(default='trumans',
                         metadata={
                             "help": "Dataset name (choose from list).",
                             "choices":
                             ['humanml', 'trumans', 'egobody', 'gimo', 'amass']
                         })
    data_dir: str = field(
        default="",
        metadata={
    ...
    smpl: bool = field(default=True, metadata={"help": "Use SMPL parameters."})
    data_rep: str = field(
        default='smpl_glo',
        metadata={"help": "Data representation for training. smplx parameters\
                        global joints, local joints with global root",
                "choices":
                    ['smpl', 'smpl_loc', 'smpl_glo', 'smpl_loc_glo', 'loc_glo', 'loc', 'glo']})
    scene: str = field(default='occ',
                         metadata={
                             "help": "Scene encoding type.",
                             "choices":
                             ['occ', 'bps']
                         })
    
    scene_type: str = field(default='occ_map24',
                            metadata={
                                "help":
    ...
    scene_size: int = field(default=48,
                            metadata={"help": "Transformer/GRU width."})
    not_scale: bool = field(default=False, metadata={"help": "Whether scaling scene."})
...
class TrainingOptions:
    ...
    wo_frame_feature: bool = field(default=True, metadata={"help": "without scene feature."})
    wo_scene_feature: bool = field(default=False, metadata={"help": "without scene feature."})
    ...
    p1: float = field(
        default=0.0, metadata={"help": "random interval weight 1"})
    p2: float = field(
        default=1.0, metadata={"help": "random interval weight 2"})
    p_global: float = field(
        default=0.3, metadata={"help": "random interval weight 1"})
...
class SamplingOptions:
    ...
    num_keyframes: int = field(
        ...
        metadata={
            "help":
            "Num of keyframes for simplication."
        })
    idx: int = field(
        default=0,
        metadata={
    ...
    test_p2: float = field(
        default=1.0, metadata={"help": "random interval weight 2"})
    save_scene: bool = field(default=False, metadata={"help": "Save Scene Information."})
...
class FullModelArgs(BaseOptions, DataOptions, ModelOptions, DiffusionOptions, 
                   TrainingOptions, SamplingOptions, GenerateOptions, InputOptions):
    pass
...
class CondSyntArgs(BaseOptions, DataOptions, ModelOptions, DiffusionOptions,
                   TrainingOptions, SamplingOptions, GenerateOptions, CondSyntOptions, InputOptions):
    pass
...
def parse_and_load_from_model(parser: HfArgumentParser,
    ...
    args_to_overwrite = []
    for cls in [DataOptions, ModelOptions, DiffusionOptions, TrainingOptions, InputOptions]: # EvaluationOptions
